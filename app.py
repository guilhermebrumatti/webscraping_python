...
df.insert(column='Ranking', value=posi[0].str.extract('([1-91020]{1,2})\s*'), loc=0)
...
result = engine.execute('SELECT * FROM tabela_classificacao where "Time" = "Flamengo"').fetchall()
print(result)